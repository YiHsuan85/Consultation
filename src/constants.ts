...
export const DIAG_DATA: DiagnosisData = {
  ...
  NB: {
    ...
    "自我照顧的食物與營養相關知識不足",
    "缺乏執行改變的社會支持",
    "執行自我管理工作的能力發展尚未準備就緒，如：幼兒",
    "缺乏行為改變或力爭上游的價值觀",
    "自覺缺乏資源，如：時間、經濟或人際關係等，阻礙自我照顧",
    "文化習俗影響執行自我照顧的能力",
    "認知能力受損，包括：學習障礙、神經性或感官受損、失智症",
    "先前接觸到相互矛盾的資訊",
    "尚未準備好飲食或生活型態改變",
    "無意願或無興趣學習或應用相關資訊",
    "缺乏自我管理工具或決策指引"
  ...
  symptoms: [
    "沒有能力解讀數據或自我管理工具",
    "對於需要自我監測感到尷尬或憤怒",
    "不確定能夠或應該執行的改變是否會反映在自我監測紀錄的數據上",
    "有需自我照顧的相關診斷，如：糖尿病、肥胖、心血管疾病、腎臟疾病、肝臟疾病",
    "有下列疾病診斷或治療的相關狀況，如：認知障礙、情緒障礙",
    "新的醫療診斷或原有診斷及病況改變"
  ]
},
...
"製備食物／餐點的能力不足(NB2.4)": {
  ...
  symptoms: [
    "攝食量整體估計值減少",
    "過度食用便利食品、即食調理餐點或其他外食，導致無法遵循營養處方",
    "無法確認所準備的食物符合營養處方",
    "無法採購並運送食物回家",
    "有下列疾病診斷或治療的相關狀況，如：認知障礙、腦性麻痺、半身不遂、視力不良、嚴格治療方案、近期手術"
  ]
},
     "生活營養品質(NQOL)差(NB2.5)": {
  etiologies: [
  ...
  symptoms: [
    "營養相關生活品質量表（NQOL）分數下降",
    "生活品質量表（如 SF-36、EORTC QLQ-C30）顯示生活品質下降",
    "糧食不安全或無意願透過可利用的社區服務取得食物",
    "對營養治療（MNT）的建議感到挫折或不滿意",
    "對控制不良感到挫折",
    "MNT 建議相關資訊錯誤或不完整",
    "無能力改變食物及身體活動相關行為",
    "關心之前學習資訊的企圖",
    ...
    "不願意或沒興趣學習資訊",
    "有新的醫療診斷或既有診斷、病況改變",
    "近期其他生活型態改變，如：戒菸、開始運動、工作轉換、住家搬遷",
    "缺乏家庭及社會支持",
    "種族及文化相關問題"
  ]
},
