  ...
  NI: {
    ...
    problems: {
     ...
     "維生素攝取不足(需指明) (NI-5.9.1)": {
      ...
      "體重過輕(NC3.1)": {
        etiologies: ["預期將受制於無法動或身體活動量減少之體能需求改變", "熱量攝取不足", "熱量需求增加", "活動量過高", "有食物攝取禁忌或限制", "飲食失調", "環境經濟因素", "胎兒體位小於懷孕週期應有體重、於子宮內生長遲緩或受限、或每日體重增加不足" ],
        symptoms: [ "BMI < 18.5 kg/m^2 (成人)", "皮下脂肪厚度、中臂肌肉圍減少", "體瘦、缺乏體脂肪", "肌肉變少", "攝取量小於建議量", "食物供應不足", "節食、不良的飲食流行時尚",  "長期饑餓", "拒絕進食", "活動量大於建議量", "使用影響食欲的藥物", "營養不良，維生素、礦物質缺乏", "有疾病或身心障礙", "有精神障礙或失智疾病", "新陳代謝率過高", "舞蹈、體操等運動員", "照顧不當之幼兒", "有飲食偏好" ]
      },
      "體重過重/肥胖(NC3.3)": {
